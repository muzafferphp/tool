            ...
            <td id="page">
                <table style="margin:20px 10px;">
                    ...
                    <tr style="background-color:#ccc;border-bottom:1px solid #ccc;">
                        ...
                        <td style="padding: 10px;">Receipt State</td>
                    ...
                    <tr>
                        <td style="padding: 10px;">
                            <a target="_blank"
                               href="{{ route('user.Recpt.print.'.$rec->state_subdomain_prefix,['rec'=>$rec->receipt_no]) }}">{{$rec->receipt_no_gen}}</a>
                            {{-- <a target="_blank"
                        ...
                        <td style="padding: 10px;">{{$rec->state_name}}</td>
