...
<div class="container-fluid">
    <div class="row d-justify-content-center">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h5>Proceed to Update Package to Customer: [{{$Customer->customer_id}}] {{$Customer->name}}</h5>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($packageChecked)
                            <form
                                action="{{route('admin.customer.package.proceed-to-update.post',[ 'Customer' => $Customer->id,'Package' => $pkg->id])}}"
