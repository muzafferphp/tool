    ...
    <div class="container-fluid">
        <div class="page-header-content">
            <h1 class="page-header-title">
                ...
                <span>Import Client Data(Custom)</span>
            </h1>
...
<div class="container-fluid mt-n10">
    <div class="card mb-4">
        <div class="card-header">Import Client Data(Custom)</div>
        <div class="card-body">
            <div class="container-fluid">
                <div class="row d-justify-content-center">
                    <div class="col-md-12">
                        <p class="text-center h3">Import Client Data From CSV File</p>

                        <form action="{{ route('job.customer.import-dynamic.do') }}" method="post"
                            enctype="multipart/form-data">

                            <div class="form-row">
                                <div class="form-group col-md-2">
                                    <div class="col-md-12">
                                        <a href="{{ route('job.customer.import-dynamic.download-blank') }}" class="btn btn-secondary">
