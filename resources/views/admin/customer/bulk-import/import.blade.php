...
<div class="container-fluid">
    <div class="row d-justify-content-center">
        <div class="col-md-12">
            <p class="text-center h3">Import Customers From CSV File</p>

            <div class="card-header">
            </div>
            <div class="card-body">
                <form action="{{ route('admin.customer.bulk-import.upload') }}" method="post"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-12">
                                <label for="IgnoreErrorsIfIgnorable" >
                                    <input type="checkbox" name="IgnoreErrorsIfIgnorable" id="IgnoreErrorsIfIgnorable" value="1">
                        ...
                        <tr>
                            <td>
                                ...
                                <a style="margin-top: 5px;"
                                    ...
                                    class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                --}}
                                <div class="dropdown">
