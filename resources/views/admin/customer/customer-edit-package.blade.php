    ...
    <div class="row d-justify-content-center">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="form">
                        @isset($currentPackage)
                        <h5>Edit Package </h5>

                        <form method="POST" action="{{ route('admin.customer.package.check-to-update.post',[ 'Customer' => $Customer->id ]) }}"
                            class="row">
                            @csrf
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-12">
                                    <select class="form-control" name="internet_package_id" id="" value="{{$currentPackage->internet_package_id}}">
                                        ...
                                        <option
                                            value="{{$p->id}}" @if ($pkg_vl==$p->id) selected='selected'
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="start_date" class="form-control datepicker"
                                        ...
                                        value="{{old('start_date', $currentPackage->package_start_date->format('d/m/Y'))}}">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="fordiscount" class="col-md-12 col-md-6">Packages Discount</label>
                                <div class="col-md-12">
                                    <input  class="form-control" type="text"  placeholder="₹" textmode="Number" pattern="^[0-9]+(\.?[0-9]+)?$" name="discount_amount" value="{{old('discount_amount', $currentPackage->discount_amount)}}" >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="col-md-12">
                                    <input class="form-control" type="text"  placeholder="₹" textmode="Number" pattern="^[0-9]+(\.?[0-9]+)?$" name="charge_amount" value="{{old('charge_amount', $currentPackage->charge_amount)}}">
                                </div>
                            </div>
                            ...
                            <div class="col-12 text-center">
                                ...
                                <button type="submit" class="btn btn-success m-l-5">Yes, Proceed To Update</button>
                ...
                <div class="col-md-5 d-none">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        @endphp
                        <li class="list-group-item @if($isCurrent) active @endif" @if($isCurrent)
