...
<div class="container-fluid">
    <div class="row d-justify-content-center">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h5>Proceed to Assign Package to Customer: [{{$Customer->customer_id}}] {{$Customer->name}}</h5>
                    <div class="form">
                        @if ($packageChecked)
                        <form
                            action="{{route('admin.customer.package.proceed-to-assign.post',['Customer' => $Customer->id,'Package' => $pkg->id])}}"
                            method="post">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    <label for="startdate" class="col-md-12 col-md-6">Revisions</label>
                                    <div class="col-md-12">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-md-12">
                                        <input  class="form-control" type="text" textmode="Number"
                                        pattern="^[0-9]+(\.?[0-9]+)?$" disabled value="{{$pckgDiscount}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        pattern="^[0-9]+(\.?[0-9]+)?$" disabled value="{{$pckgCharge}}">
                                    </div>
                                </div>
                                <div class="form-group col-md-3 disabled-control">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input @if($assignToIpbill) checked="checked" @endif type="checkbox"
                                            ...
                                            data-offstyle="danger" data-width="10rem" value="1" disabled-control
                                            data-value="1" />
                                ...
                                <div class="col-12 text-center">
                                    ...
                                    @if (!$isGstEnabled)
                                    @endif
                                    <h3>Bill Amount : ₹{{number_format($total_bill_amount,2)}}/-</h3>
