...
<head>
    <title>RECEIPT - {{ $invoice->slno_gen }}</title>
...
<body class="c29" onload="doPrint()">
    <div class="row">
        <div class="col-xs-8">
            ...
            <p class="c22"><span
                    class="c0">{{$bz['business-address']['city']}},{{$bz['business-address']['state']}},{{$bz['business-address']['pin']}}</span>
            </p>
        ...
        <div class="col-xs-4 float-right-x ">
            <p class="c37 text-right">
                <span class="c6 c33">RECEIPT</span>
            </p>
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <table class="w-100 invc-det">
                <tr>
                    <td class="text-right titles-td c5 c6">Receipt Number</td>
                    <td class="text-center colon-td">:</td>
                    <td class="text-left values-td"><span class="c0">{{ $receipt->slno_gen }}</span></td>
                </tr>
                @if ($invoice)
                <tr>
                ...
                @endif
                <tr>
                    <td class="text-right titles-td c5 c6">Payment Date</td>
                    <td class="text-center colon-td">:</td>
                    <td class="text-left values-td"><span
                            class="c0">{{ $invoice->generated_at->format('d-M-Y') }}</span></td>
                </tr>
                <tr>
            ...
            <table class="c38">
                <tbody>
                    <tr class="c4 job-thead">
                        <td class="c21 c27" colspan="2" rowspan="1">
                    ...
                    <tr class="c4">
                        <td class="c21" colspan="2" rowspan="1">
                            <p class="c7"><span class="c0">
                                    Payment payable against invoice #{{$invoice->slno_gen}}.
                                </span></p>
                        </td>
                    ...
                    <tr class="c4">
                        ...
                        <td class="c25" colspan="1" rowspan="1">
                            <p class="c7"><span class="c0">{{$payment->paid_amount_f}}</span></p>
                        </td>
                    </tr>
                    @endif
                    ...
                    {{-- <tr class="c4">
                        <td class="c16" colspan="1" rowspan="1">
                            <span class="c18" id="h.35hyw3af8rns">
                                <span class="c5 c6">&nbsp;Total Paid </span>
                            </span>
                        </td>
                        <td class="c25" colspan="1" rowspan="1">
                        ...
                        <td colspan="3">
                            ...
                            <table class="prnt-det W-100">
                                <tr>
                                    ...
                                    <td class="text-center colon-td">:</td>
                                    <td class="text-left values-td"><span class="c0">{{ $receivedBy->full_name}} (
                                            {{$receivedBy->user_type_name}} )</span></td>
                                </tr>
                                <tr>
                                    <td class="text-right titles-td c5 c6">Receipt Printed By</td>
                                    <td class="text-center colon-td">:</td>
                                    <td class="text-left values-td"><span class="c0">{{ $user->full_name}} (
                                            {{$user->user_type_name}} )</span></td>
                                </tr>
                                <!--
                                    <tr>
                                        <td class="text-right titles-td c5 c6">Payment Received By</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center colon-td">:</td>
                                    <td class="text-left values-td"><span
                                            class="c0">{{ now()->format('d-M-Y h:i:s a') }}</span></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
