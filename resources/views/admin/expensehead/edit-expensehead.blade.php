...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.expensehead.edit',['expenseId' => $expenseId])}}" method="POST">
        @csrf
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="expense_mode_name" class="col-md-12 col-sm-6">Expense Head Name <span style="color: red;"
                        class="mandatoryClass">*</span></label>
                <div class="col-md-12">
                    <input name="name" class="form-control" type="text" value="{{old('name', $expense->name)}}">
                </div>
            </div>
            <div class="form-group col-md-6">
                <label for="title" class="col-md-12 col-sm-6">Title</label>
                <div class="col-md-12">
                    <input name="title" class="form-control" type="text" value="{{old('title', $expense->title)}}">
                </div>
            </div>
        </div>
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-12">
                    <textarea class="form-control" name="description" id="" cols="30" rows="5"
                        value="">{{old('description', $expense->description)}}</textarea>
                </div>
            </div>
        ...
        <div class="form-row">
            <div class="form-group ">
                ...
                <div class="col-md-12">
                    ...
                    value="1" data-value="{{old('is_active', $expense->is_active)}}"/>
                </div>
            </div>
            <div class="col-md-12">
