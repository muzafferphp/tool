...
<div class="container-fluid">
    ...
    <form action="{{route('admin.packages.edit',['packageId' => $packageId])}}" method="POST">
        @csrf
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <div class="col-md-12">
                    <select class="form-control" name="package_category" id="" value="{{$package->package_category}}">
                        {{-- <option></option> --}}
                        <option value="unlimited" @if (old('package_category', $package->package_category)=='unlimited'
                            ) selected="selected" @endif>UNLIMITED</option>
                        <option value="limited" @if (old('package_category', $package->package_category)=='limited' )
                            selected="selected" @endif>LIMITED</option>
                    </select>
                </div>
            </div>
            <div class="form-group col-md-6">
                ...
                <div class="col-md-12">
                    <input class="form-control" name="package_limit_text" type="text"
                        placeholder="'5mbps' or '3mbps, 30GB'"
                        value="{{old('package_limit_text', $package->package_limit_text)}}">
                </div>
            </div>
        </div>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-md-12">
                    <input class="form-control" name="package_duration_days" type="number"
                        placeholder="Package Duration" min="1"
                        value="{{old('package_duration_days', $package->package_duration_days, 30)}}">
                </div>
            </div>
            <div class="form-group  col-md-4">
                <label for="durationtext" class="col-md-12 col-md-6">Duration Text</label>
                <div class="col-md-12">
                    <input class="form-control" name="package_duration_text"
                        value="{{old('package_duration_text', $package->package_duration_text)}}" type="text"
                        placeholder="'One Month' or '3 months'">
                </div>
            </div>
            <div class="form-group col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <input class="form-control" name="is_active" type="checkbox" {{-- @if ($package->is_active)
                    checked="checked"

                    @endif --}} @if ($isac==1) checked="checked" @endif data-toggle="toggle" data-on="Active"
                        data-off="Inactive" data-onstyle="success" data-offstyle="danger" data-width="10rem" value="1"
                        data-value="{{old('is_active', $package->is_active)}}">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-12">
                    <textarea name="package_description" id="" cols="20" rows="2" class="form-control"
                        value="">{{old('package_description',$package->package_description)}}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <div class="col-md-12">
                    <input class="form-control" id="UnfilterdPrice_TXT" type="text" placeholder="₹"
                        value="{{old('package_amount_w_tax', $package->package_amount_w_tax)}}">
                </div>
            </div>
            <div class="form=group col-md-4">
                <label for="isgstincluded">Is GST Included</label>
                <div class="col-md-12">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <select name="ipbill_package_rid" id="" class="form-control"
                        value="{{$package->ipbill_package_rid}}">
                        <option value="">Select</option>
                        @php
                        $ip_bill=old('ipbill_package_rid',$package->ipbill_package_rid);
                        @endphp
                        @foreach ($allipbillpackages as $bill_pack)
                        <option value="{{$bill_pack->rid}}" @if ($ip_bill==$bill_pack->rid)
                ...
                <div class="border border-0 m-2 p-1 small">
                    <div class="row" style="position: relative;">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="package_amount_wo_tax" id="Price_TXT" class="form-control"
                                    placeholder="₹" value="{{$package->package_amount_wo_tax}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="package_amount_w_tax" id="GSTPrice_TXT" class="form-control"
                                    placeholder="₹" value="{{$package->package_amount_w_tax}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="package_amount_tax_amount" id="GSTAmt_TXT" class="form-control"
                                    placeholder="₹" value="{{$package->package_amount_tax_amount}}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="package_amount_tax_rate" id="GSTRate_TXT" class="form-control"
                                    placeholder="₹" value="{{$package->package_amount_tax_rate}}" />
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-12 text-center">
    <button class="btn btn-danger w-25 m-auto" type="submit">Update</button>
</div>
