            ...
            <div class="container">
                <div class="col-md-5 m-auto">
                    ...
                    <form action="" method="post">
                        @csrf
                        <input type="textbox" value="{{$cat->Chksm}}" name="chksm" hidden>
                        <div class="form-group">
                            <label for="id">Requested Category ID</label>
                            <input type="text" value="{{$cat->id}}" name="id" id="id" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                            <label for="">Requested Category Title</label>
                            <input type="text" value="{{$cat->title}}" name="title" id="title" class="form-control" disabled>
                        </div>
