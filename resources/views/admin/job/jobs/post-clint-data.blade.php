...
<script>
    ...
    function CDCreateSection(customData, fromContainer) {
        ...
        window.custom_dynamic_data_type_id = customData.pivot.custom_dynamic_data_type_id;
        var dataCount = customData.pivot.count > 0 ? customData.pivot.count : 1;
        ...
        wFrmD
        .data({
          limit: customData.pivot.count,
          rawData: Object.assign({}, customData),
        })
        .attr({
          "data-limit": customData.pivot.count,
        });
        wrp.append(wFrmD);
        CDRefreshData();
    }
    ...
    function CDCreateSectionRow(customData, index) {
      ...
      `);
      //new
      window.dataTypeID = customData.pivot.custom_dynamic_data_type_id;
    ...
    function GenerateFieldNameFormIndex(element, CData, rowIndex) {
        ...
        if(element.attr('class') == 'form-control cd-control-input'){
             ...
             namePrefix = `CustomData[${CData.slug}][${rowIndex}][${dType.child_slug}][custom_dynamic_data_type_id]`;
    ...
    function CDRefreshData() {
      ...
      var Sections = wrp.find(".card").each(function (ind, sect) {
        ...
        var reachedLimit = customData.pivot.count == rows;
