...
<div class="container-fluid mt-n10">
    <div class="card mb-4 card-header-actions">
        <div class="card-header">All Jobs
            <a href="{{route('job.job.add.step.1')}}" class="btn btn-primary btn-sm">
                                    ...
                                    <span>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="{{$b1id}}">
                                                <a class="dropdown-item" href="{{route('job.job.details', ['id' => $item->id ])}}">View Details</a>
                                                <a class="dropdown-item" href="{{route('job.job.delete', ['id' => $item->id ])}}">Delete</a>
                                            </div>
                                        </div>

                                    </span>
                                </td>
                                <td>{!! $item->JobType?$item->JobType->title:"" !!}</td>
                                <td>{!! $item->slno_gen !!}</td>
                                <td>{!! $item->JobCustomer?$item->JobCustomer->full_name:"" !!}</td>
                                <td>{!! $item->job_created_at !!}</td>
                                <td>{!! $item->job_ends_at !!}</td>
