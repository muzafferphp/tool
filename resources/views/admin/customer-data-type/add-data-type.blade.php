...
<div class="container-fluid mt-n10">
    <div class="card mb-4">
        ...
        <div class="card-body p-3">
            ...
            <form action="{{route('admin.settings.dynamic-data-type.add.post')}}" method="POST"
...
<script>
    ...
    function FormLoader(){
        ...
        function AddDDOption(num, total_fields){
            ...
            if(total_options == 0){
                DDoptionBody.find('button').remove();
            }
            $($("#row-" + num + "-field-" + total_fields + "-options")).append(DDoptionBody);
        }
