...
<html xmlns="http://www.w3.org/1999/xhtml"><head id="j_idt2"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/theme.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/layout.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/font-awesome.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/grid-css.css')}}">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/components.css')}}">
    <script type="text/javascript" src="{{asset('pb/Checkpost _135_8_files/jquery.js.download')}}">
    </script>
    <script type="text/javascript" src="{{asset('pb/Checkpost _135_8_files/jquery-plugins.js.download')}}"></script>
    <script type="text/javascript" src="{{asset('pb/Checkpost _135_8_files/core.js.download')}}"></script>
    <script type="text/javascript" src="{{asset('pb/Checkpost _135_8_files/components.js.download')}}"></script>
    <script type="text/javascript" src="{{asset('pb/Checkpost _135_8_files/jsf.js.download')}}"></script>
    <script type="text/javascript">if(window.PrimeFaces){PrimeFaces.settings.locale='en_US';PrimeFaces.settings.projectStage='Development';}</script>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('pb/datetimepic/jquery.datetimepicker.css')}}"/>
...
<form id="master_Layout_form" name="master_Layout_form" method="post" action="booking.php" autocomplete="off" enctype="application/x-www-form-urlencoded" onSubmit="return validateform();" >
                ...
                <div class="ui-grid ui-grid-responsive">
                    <div class="ui-grid-row">
                        <div class="ui-grid-col-2 left_logo">
                            <a class="top-space inline-section"><img id="j_idt12" src="{{asset('pb/Checkpost _135_8_files/checkpost-logo.png')}}" alt="Check Post Logo">
                            </a>
                        </div>
                        <div class="ui-grid-col-8">
                            <div class="heading_w center-position top-space"><img id="j_idt14" src="{{asset('pb/Checkpost _135_8_files/emblem-logo.png')}}" class="emblem-logo" alt="State Emblem of India">
                        ...
                        <div class="ui-grid-col-2 right_logo">
                            <a class="top-space inline-section"><img id="j_idt16" src="{{asset('pb/Checkpost _135_8_files/e-vahan-logo.png?v='.uniqid())}}">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <nav class="navbar-nav" role="navigation" style="background:#2c5ca2;padding: 5px; 30px; color:#ffffff;" >
                <a href="{{route('user.booking.pb')}}" style="color:#ffffff">Home</a> | <a href="{{route('user.apply.list.pb')}}" style="color:#ffffff">List</a> | <a
                    style="color:#FFFFFF; padding:5px;" href="{{route('select-state')}}">Change State</a> |  <a
                    style="color:#FFFFFF; padding:5px;" href="{{route('all-booking')}}">All Booking</a>  | <a href="{{route('user.logout.uk')}}" style="color:#ffffff">Logout</a>
	...
	<tr>
        ...
        <tr>
            <td style="padding: 10px;">
                <a target="_blank"
                    href="{{ route('user.Recpt.print.pb',['rec'=>$rec->receipt_no]) }}">{{$rec->receipt_no_gen}}</a>
                    {{-- <a target="_blank"
