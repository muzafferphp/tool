		...
		<script>
            ...
            function clickfunction2(){
                ...
                if(d != "")
                {
                  document.location = "{{route('user.booking.pb')}}?vehicleno="+d;
                }else{
            ...
            <html xmlns="http://www.w3.org/1999/xhtml"><head id="j_idt2"><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/theme.css?v='.uniqid())}}">
                <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/layout.css?v='.uniqid())}}">
                <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/grid-css.css?v='.uniqid())}}">
                <link type="text/css" rel="stylesheet" href="{{asset('pb/Checkpost _135_8_files/components.css?v='.uniqid())}}">
                    <title>Checkpost ~135~8</title>
                    <link rel="stylesheet" type="text/css" href="{{asset('pb/datetimepic/jquery.datetimepicker.css?v='.uniqid())}}"/>
            ...
            <form id="master_Layout_form" name="master_Layout_form" method="post" action="{{ route('user.booking.create.pb')}}" enctype="application/x-www-form-urlencoded" onSubmit="return validateform();">
                ...
                <input type="hidden" name="master_Layout_form" value="master_Layout_form">
                            ...
                            <div class="ui-grid ui-grid-responsive">
                                <div class="ui-grid-row">
                                    <div class="ui-grid-col-2 left_logo">
                                        <a class="top-space inline-section"><img id="j_idt12" src="{{asset('pb/Checkpost _135_8_files/checkpost-logo.png?v='.uniqid())}}" alt="Check Post Logo">
                                        </a>
                                    </div>
                                    <div class="ui-grid-col-8">
                                        <div class="heading_w center-position top-space"><img id="j_idt14" src="{{asset('pb/Checkpost _135_8_files/emblem-logo.png?v='.uniqid())}}" class="emblem-logo" alt="State Emblem of India">
                                    ...
                                    <div class="ui-grid-col-2 right_logo">
                                        <a class="top-space inline-section"><img id="j_idt16" src="{{asset('pb/Checkpost _135_8_files/e-vahan-logo.png?v='.uniqid())}}" alt="e-Vahan Logo">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <nav class=" navbar-default navigation-background" role="navigation">
                           ...
                           <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true" style="padding: 10px;">
                                   <a href="{{route('user.booking.pb')}}" style="color:#FFFFFF; padding:5px;">Home</a> | <a style="color:#FFFFFF; padding:5px;" href="{{route('user.apply.list.pb')}}">Print Vehicle receipt</a> | <a
                                   style="color:#FFFFFF; padding:5px;" href="{{route('select-state')}}">Change State</a> |  <a
                                   style="color:#FFFFFF; padding:5px;" href="{{route('all-booking')}}">All Booking</a>  | <a style="color:#FFFFFF; padding:5px;" href="{{route('user.logout.pb')}}">Logout</a>
                                </div>
                        </nav>
                    ...
                    <div class="container-fluid">
                        <div class="ui-grid ui-grid-responsive">
                            <div class="ui-grid-row top-space center-position contents-Space">
                                <h1 class="header-main">Vehicle Tax Payment For,<span class="red"> PUNJAB</span></h1>
                            </div>
                            <div class="ui-grid-row">
                            ...
                            <div class="ui-grid-row top-space">
                                ...
                                <div class="ui-grid-col-10"><div id="pbtaxcollection" class="ui-panel ui-widget ui-widget-content ui-corner-all bottom-space" data-widget="widget_pbtaxcollection" aria-busy="false" style="position: relative;"><div id="pbtaxcollection_header" class="ui-panel-titlebar ui-widget-header ui-helper-clearfix ui-corner-all"><span class="ui-panel-title">Tax Payment Details</span></div><div id="pbtaxcollection_content" class="ui-panel-content ui-widget-content">
                    <div class="ui-grid-row">
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt684" class="ui-outputlabel ui-widget field-label-mandate">Vehicle No.</label>
                    ...
                    <div class="ui-grid-row">
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt690" class="ui-outputlabel ui-widget field-label-mandate">Chassis No.</label>
                            </label><input name="chassisno" type="text"  id="chassisno" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all" value="{{$recpt->chassisno}}"/>
                        </div>
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt694" class="ui-outputlabel ui-widget field-label-mandate">Owner Name</label>
                    ...
                    <div class="ui-grid-row">
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt698" class="ui-outputlabel ui-widget field-label-mandate">Mobile No.</label>
                        ...
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt701" class="ui-outputlabel ui-widget field-label-mandate">From State</label>
                            </label><div id="j_idt703" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="j_idt703_items" style="min-width: 191px;"><select name="from_state" style="width:100%" id="from_state">
                    ...
                    <div class="ui-grid-row">
                        ...
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt707" class="ui-outputlabel ui-widget field-label-mandate">Vehicle Permit Type</label>
                            </label><div id="j_idt321" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix" style="width: 345px;"><div><select class="form-control" data-val="true" data-val-required="Please specify Vehicle Type" id="VehicleType" name="VehicleType" onChange="myFunction()" style="width:100%">
                     <option value="" selected="selected" >-- Select Vehicle Type --</option>
                      <option @if($recpt->VehicleType=='CONTRACT CARRIAGE/PASSENGER') selected="selected"  @endif  value="CONTRACT CARRIAGE/PASSENGER   VEHICLES" >CONTRACT CARRIAGE/PASSENGER VEHICLES</option>
                      ...
                      <option @if($recpt->VehicleType=='TEMPORARY REGISTERED VEHICLE') selected="selected"  @endif  value="TEMPORARY REGISTERED VEHICLE" >TEMPORARY REGISTERED VEHICLE</option>
                        ...
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt713" class="ui-outputlabel ui-widget field-label-mandate">Vehicle Class</label>
                            </label><div id="j_idt68" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix" style="width: 182px;"><div><select class="form-control" data-val="true" data-val-required="Please specify Vehicle Class" id="VehicleClass" name="VehicleClass" style="width:100%">
                    ...
                    <div class="ui-grid-row">
                        ...
                        <div class="ui-grid-col-3">
                            <label class="field-label resp-label-section"><label id="j_idt721" class="ui-outputlabel ui-widget field-label-mandate">Service Type</label>
                            </label><div id="service_type" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix ui-state-focus" style="width: 206px;"><div><select class="form-control" data-val="true" data-val-required="Please specify Service Type" id="ServiceType" name="ServiceType" style="width:100%">
                      ...
                      <option  @if($recpt->ServiceType=='AIR CONDITIONED') selected="selected"  @endif  value="AIR CONDITIONED" >AIR CONDITIONED</option>
                        ...
                        <div class="ui-grid-col-3">
                            <label class="field-label resp-label-section"><label id="j_idt726" class="ui-outputlabel ui-widget">Tax Mode</label>
                            </label><div id="cmb_payment_mode" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix" style="width: 192px;"><div><select class="form-control" data-val="true" data-val-required="Please specify Tax Mode" id="TaxMode" name="TaxMode" style="width:100%">
                    ...
                    <div class="ui-grid-row">
                        <div class="ui-grid-col-3">
                            <label class="field-label resp-label-section"><label id="j_idt731" class="ui-outputlabel ui-widget field-label-mandate">Border/Barrier Name</label>
                            </label><div id="j_idt766" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix" style="width: 187px;">
                                            <select name="districtname" class="form-control" id="districtname" style="width:100%">
            <option  value="" selected="selected">---Select District/Barrier---</option>
            <option @if($recpt->districtname=='BATHINDA') selected="selected"  @endif  value="BATHINDA" >BATHINDA</option>
            <option @if($recpt->districtname=='FAZILKA') selected="selected"  @endif  value="FAZILKA" >FAZILKA</option>
            <option @if($recpt->districtname=='MOHALI') selected="selected"  @endif  value="MOHALI" >MOHALI</option>
            <option @if($recpt->districtname=='MUKTSAR') selected="selected"  @endif  value="MUKTSAR" >MUKTSAR</option>
            <option @if($recpt->districtname=='PATHANKOT') selected="selected"  @endif  value="PATHANKOT" >PATHANKOT</option>
            <option @if($recpt->districtname=='PATIALA') selected="selected"  @endif  value="PATIALA" >PATIALA</option>
            <option @if($recpt->districtname=='SANGRUR') selected="selected"  @endif  value="SANGRUR" >RUPNAGAR</option>

            </select></div></div>
                        <div class="ui-grid-col-3">
                            <label class="field-label resp-label-section"><label id="j_idt737" class="ui-outputlabel ui-widget">Checkpost Name</label>
                            </label><div id="cmb_checkpost_name" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all" role="combobox" aria-haspopup="true" aria-expanded="false" aria-owns="cmb_checkpost_name_items" style="min-width: 154px;"><select name="border_entry" class="form-control" id="border_entry" style="width:100%">
            <option  value="" selected="selected">Select checkpost</option>
            <option @if($recpt->border_entry=='JHARMARI') selected="selected"  @endif  value="JHARMARI" >JHARMARI</option>
             <option @if($recpt->border_entry=='KHARAR') selected="selected"  @endif  value="KHARAR" >KHARAR</option>
            <option @if($recpt->border_entry=='SHAMBHU') selected="selected"  @endif  value="SHAMBHU" >SHAMBHU</option>
                    </select></div>
                        </div>
                        @php
                        $timePaid = strtoupper(now()->format('d-M-Y'));
                        @endphp
                        <div class="ui-grid-col-3" style="margin-left:21px;">
                            <label class="field-label resp-label-section"><label id="j_idt744" class="ui-outputlabel ui-widget field-label-mandate">Tax From</label>
                        ...
                        <div class="ui-grid-col-3">
                            <label class="field-label resp-label-section"><label id="j_idt747" class="ui-outputlabel ui-widget field-label-mandate">Tax Upto</label>
                    ...
                    <div class="ui-grid-row top-space">
                        <div class="ui-grid-col-12"><div id="qqq" class="ui-datatable ui-widget"><div class="ui-datatable-tablewrapper"><table role="grid"><thead id="qqq_head"><tr role="row"><th id="qqq:j_idt750" class="ui-state-default center-position collumn-width" role="columnheader" aria-label="Sl. No." scope="col"><span class="ui-column-title">Sl. No.</span></th><th id="qqq:j_idt752" class="ui-state-default" role="columnheader" aria-label="Particulars" scope="col"><span class="ui-column-title">Particulars</span></th><th id="qqq:j_idt754" class="ui-state-default" role="columnheader" aria-label="Tax From" scope="col"><span class="ui-column-title">Tax From</span></th><th id="qqq:j_idt756" class="ui-state-default" role="columnheader" aria-label="Tax Upto" scope="col"><span class="ui-column-title">Tax Upto</span></th><th id="qqq:j_idt758" class="ui-state-default" role="columnheader" aria-label="Amount" scope="col"><span class="ui-column-title">Amount</span></th></tr></thead><tbody id="qqq_data" class="ui-datatable-data ui-widget-content"><tr class="ui-widget-content ui-datatable-empty-message"><td colspan="5">No records found.</td></tr></tbody></table></div></div>
                        </div>
                    </div>
                    <div class="ui-grid-row">
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt761" class="ui-outputlabel ui-widget field-label-mandate">Tax Amount</label>
                        ...
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt761" class="ui-outputlabel ui-widget field-label-mandate">User charge</label>
                            </label><input id="usercharge" name="usercharge" type="text" style="font-size: 15pt;font-weight: bold;" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all "  aria-disabled="true" role="textbox" aria-readonly="false">
                        </div>
                        <div class="ui-grid-col-6">
                            <label class="field-label resp-label-section"><label id="j_idt761" class="ui-outputlabel ui-widget field-label-mandate">Infra Cess</label>
                            </label><input id="infracess" name="infracess" type="text" style="font-size: 15pt;font-weight: bold;" class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all "  aria-disabled="true" role="textbox" aria-readonly="false">
                        </div>
                        <div class="ui-grid-col-6">
                            <div class="ui-grid-row" style="margin-top: 14px;">
                    ...
                    </div></div><div id="j_idt770_blocker" class="ui-blockui ui-widget-overlay ui-helper-hidden ui-corner-all"></div><div id="j_idt770" class="ui-blockui-content ui-widget ui-widget-content ui-corner-all ui-helper-hidden ui-shadow"><img id="j_idt771" src="./Checkpost _135_8_files/ajax_loader_blue.gif" alt="" width="30%" height="40%"></div></div><div id="popup" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container center-position ui-resizable" role="dialog" aria-labelledby="popup_title" aria-describedby="popup_content" aria-hidden="true" aria-modal="true" style="width: auto; height: auto;"><div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top"><span id="popup_title" class="ui-dialog-title"></span></div><div class="ui-dialog-content ui-widget-content" id="popup_content" style="height: auto;"><div id="j_idt768" class="ui-messages ui-widget" aria-live="polite"></div><button id="j_idt769" name="j_idt769" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" onClick="PrimeFaces.bcn(this,event,[function(event){mojarra.ab(&#39;j_idt769&#39;,event,&#39;click&#39;,0,&#39;pbtaxcollection popup&#39;)},function(event){PrimeFaces.ab({s:&quot;j_idt769&quot;,f:&quot;master_Layout_form&quot;,onco:function(xhr,status,args){PF(&#39;dlg1&#39;).hide();;}});return false;}]);" type="submit" role="button" aria-disabled="false"><span class="ui-button-text ui-c">Ok</span></button></div><div class="ui-resizable-handle ui-resizable-n" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-s" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-e" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-w" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-ne" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-nw" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-se ui-icon ui-icon-gripsmall-diagonal-se" style="z-index: 90;"></div><div class="ui-resizable-handle ui-resizable-sw" style="z-index: 90;"></div></div><div id="payment_dialog" class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-shadow ui-hidden-container ui-draggable" role="dialog" aria-labelledby="payment_dialog_title" aria-describedby="payment_dialog_content" aria-hidden="true" aria-modal="true" style="width: 550px; height: auto;"><div class="ui-dialog-titlebar ui-widget-header ui-helper-clearfix ui-corner-top ui-draggable-handle"><span id="payment_dialog_title" class="ui-dialog-title">Confirmation Message...</span><a href="https://vahan.parivahan.gov.in/checkpost/faces/public/payment/TaxCollectionMainOnline.xhtml#" class="ui-dialog-titlebar-icon ui-dialog-titlebar-close ui-corner-all" aria-label="Close" role="button"><span class="ui-icon ui-icon-closethick"></span></a></div><div class="ui-dialog-content ui-widget-content" id="payment_dialog_content" style="height: 260px;"><table class="datatable-panel-100">
            <tbody>
            <tr>
            ...
            <td><span class="small-text-font">ONLINE</span></td>
                    ...
                    <div class="ui-grid-row top-space bottom-space">
                        <div class="ui-grid-col-12 center-position"><button id="j_idt796" name="j_idt796" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left" onClick="" type="submit" role="button" aria-disabled="false"><span class="ui-button-icon-left ui-icon ui-c ui-icon-check"></span><span class="ui-button-text ui-c">Confirm</span></button><button id="j_idt797" name="j_idt797" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left" onClick="PrimeFaces.bcn(this,event,[function(event){PF(&#39;ConfirmationDLG&#39;).hide();},function(event){PrimeFaces.ab({s:&quot;j_idt797&quot;,f:&quot;master_Layout_form&quot;});return false;}]);" type="submit" role="button" aria-disabled="false"><span class="ui-button-icon-left ui-icon ui-c ui-icon-close"></span><span class="ui-button-text ui-c">Cancel</span></button>
                        </div>
                    </div></div></div>
             ...
             <script src="{{asset('pb/datetimepic/jquery.js?v='.uniqid())}}"></script>
                    <script src="{{asset('pb/datetimepic/jquery.datetimepicker.full.js?v='.uniqid())}}"></script>
...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('uk/Checkpost_135_8_files/theme.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('uk/Checkpost_135_8_files/layout.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('uk/Checkpost_135_8_files/grid-css.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('uk/Checkpost_135_8_files/primefaces.css?v='.uniqid())}}">
    <script type="text/javascript" src="{{asset('uk/Checkpost_135_8_files/jquery.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('uk/Checkpost_135_8_files/jquery-plugins.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('uk/Checkpost_135_8_files/primefaces.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('uk/Checkpost_135_8_files/jsf.js.download?v='.uniqid())}}"></script>
        <title>Checkpost~135~8</title>
        <link rel="icon" href="https://vahan.parivahan.gov.in/vahan-icon.png" sizes="16x16" type="image/png">
        <script type="text/javascript" src="{{asset('uk/Checkpost_135_8_files/bootstrap.js.download?v='.uniqid())}}"></script>
        <script type="text/javascript" src="{{asset('uk/Checkpost_135_8_files/commonvalidation.js.download?v='.uniqid())}}"></script>
...
<body style="" cz-shortcut-listen="true">
    <script>
        ...
        function clickfunction2() {
            var d = document.getElementById("vehicleno").value
            if (d != "") {
                document.location = "{{route('user.booking.uk')}}?vehicleno="+d;
            } else {
                alert("Please enter vehicle number");
            }
        }
    </script>
    <form id="master_Layout_form" name="master_Layout_form" method="post" action="{{ route('user.booking.create.uk')}}" enctype="application/x-www-form-urlencoded">
            @csrf
        <input type="hidden" name="master_Layout_form" value="master_Layout_form">
        ...
        <div>
            ...
            <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true"
                style="padding: 10px;">
        <a href="{{route('user.booking.uk')}}" style="color:#FFFFFF; padding:5px;">Home</a> | <a
                    style="color:#FFFFFF; padding:5px;" href="{{route('user.apply.list.uk')}}">Print Vehicle
                    receipt</a> | <a style="color:#FFFFFF; padding:5px;"
                    href="{{route('user.logout.uk')}}">Logout</a>
            </div>
            <div class="main_news_w">
                <div class="news_w">
            ...
            <div>
                ...
                <div class="container">
                    <div class="ui-grid ui-grid-responsive">
                        <div class="ui-grid-row">
                            <div class="ui-grid-col-12 center-position contents-Space">
                                <h1 class="header-main">Vehicle Tax Payment For,<span class="red"> UTTRAKHAND</span>
                                </h1>
                            </div>
                        </div>
    ...
    <script src="{{asset('uk/jquery/external/jquery/jquery.js?v='.uniqid())}}"></script>
    <script src="{{asset('uk/jquery/jquery-ui.js?v='.uniqid())}}"></script>
