            ...
            <div id="j_idt10" class="ui-outputpanel ui-widget">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" class="row-p">: {{$rectdata->ownername}} </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" class="row-p">: {{$rectdata->TaxMode}} </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" class="row-p"><label>Vehilce Type</label></td>
                                            <td width="50%" class="row-p">: {{$rectdata->VehicleType}} </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" class="row-p">: {{$rectdata->border_entry}} </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" class="row-p"><label>Service Type</label></td>
                                            <td width="50%" class="row-p">: {{$rectdata->ServiceType}} </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td width="50%" class="row-p">:
                                                {{$rectdata->bank_ref_no}}</td>
                                        </tr>
                                        <tr>
                                            <td width="50%" class="row-p"><label>Payment Mode</label></td>
                                            <td width="50%" class="row-p">: {{$rectdata->payment_mode}}</td>
                                        </tr>
                                        <tr>
                        ...
                        <tr valign="top">
                            <td colspan="3"><span style="font-weight: bold;">Grand Total : {{$rectdata->total_tax_amount}}/-</span> </td>
                        </tr>
