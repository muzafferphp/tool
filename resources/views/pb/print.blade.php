...
<html xmlns="http://www.w3.org/1999/xhtml"><head id="j_idt2"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Online Tax Payment Portal_files/theme.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Online Tax Payment Portal_files/layout.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Online Tax Payment Portal_files/grid-css.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('pb/Online Tax Payment Portal_files/components.css?v='.uniqid())}}">
    <script type="text/javascript" src="{{asset('pb/Online Tax Payment Portal_files/jquery.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('pb/Online Tax Payment Portal_files/jquery-plugins.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('pb/Online Tax Payment Portal_files/core.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('pb/Online Tax Payment Portal_files/components.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('pb/Online Tax Payment Portal_files/primefaces-extensions.js.download?v='.uniqid())}}"></script><script type="text/javascript" src="./Online Tax Payment Portal_files/qrcode.js.download"></script><script type="text/javascript">if(window.PrimeFaces){PrimeFaces.settings.locale='en_US';PrimeFaces.settings.projectStage='Development';}</script>
...
<body onLoad="window.print(), textRepeat()">
    ...
    <div class="watermark">
        <!--            &lt;p style="font-size:100px;"&gt;Sample&lt;/p&gt;--><img id="j_idt10"
            src="{{asset('pb/Online Tax Payment Portal_files/PB-LOGO.png?v='.uniqid())}}" alt="">
    </div>
    <form id="formPrint" name="formPrint" method="get"
        action="{{ route('user.apply.list.pb') }}"
                        ...
                        <td colspan="3">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                                ...
                                <tr>
                                    ...
                                    <td width="35%" class="row-p">: <span class="row-p1">{{$rectdata->ServiceType}}</span> </td>
                                    <td width="15%" class="row-p"></td>
                                    <td width="35%" class="row-p"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="35%" class="row-p">: {{$rectdata->PermitType}}</td>									<td width="15%" class="row-p"><label>Permit Category</label></td>                                            <td width="35%" class="row-p"></td>
                                </tr>
                                <tr>
                            ...
                            <div>
                                <div class="ui-grid-responsive" >
                                    <table width="99%" border="0" cellspacing="0" style="border-top: 1px #000 solid;border-bottom: 1px #000 solid;border-left: none; border-right: none;" cellpadding="0">
                                        ...
                                        </tbody></table></li><li class="ui-datalist-item">
                                        <table width="99%" border="1" cellspacing="0" style="border-top: none;border-bottom: 1px #000 solid;border-left: none; border-right: none;" cellpadding="0">
                                            <tbody><tr>
                                                ...
                                                <td width="12%" style="align: right;">{{$rectdata->service_amount}}</td>
                                                <td width="12%" style="align: right;">0</td>
                                                <td width="12%" style="align: right;">{{$rectdata->service_amount}}</td>
                                            </tr>
                                        </tbody></table></li><li class="ui-datalist-item">
                                        <table width="99%" border="1" cellspacing="0" style="border-top: none;border-bottom: 1px #000 solid;border-left: none; border-right: none;" cellpadding="0">
                                            <tbody><tr>
                                                ...
                                                <td width="12%" style="align: right;">{{$rectdata->civik_amount}}</td>
                                                <td width="12%" style="align: right;">0</td>
                                                <td width="12%" style="align: right;">{{$rectdata->civik_amount}}</td>
                                            </tr>
