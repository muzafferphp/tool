...
<head id="j_idt2"> 
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('raj/Online Tax Payment Portal_files/theme.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('raj/Online Tax Payment Portal_files/layout.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('raj/Online Tax Payment Portal_files/grid-css.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('raj/Online Tax Payment Portal_files/primefaces.css?v='.uniqid())}}">
    <script type="text/javascript" src="{{asset('raj/Online Tax Payment Portal_files/jquery.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('raj/Online Tax Payment Portal_files/primefaces.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('raj/Online Tax Payment Portal_files/jquery-plugins.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('raj/Online Tax Payment Portal_files/primefaces-extensions.js.download?v='.uniqid())}}">
    </script>
    <script type="text/javascript" src="{{asset('raj/Online Tax Payment Portal_files/qrcode.js.download?v='.uniqid())}}"></script>
    <title>Online Tax Payment Portal</title>
    <script type="text/javascript" src="{{asset('raj/Online Tax Payment Portal_files/bootstrap.js.download?v='.uniqid())}}"></script>
    <style>
        @page {
            size: auto;
            margin: 2mm;
...
<body onLoad="window.print(), textRepeat()">
    ...
    <div class="watermark">
        <!--            &lt;p style="font-size:100px;"&gt;Sample&lt;/p&gt;--><img id="j_idt10"
            src="{{asset('raj/Online Tax Payment Portal_files/tdlogo4.png?v='.uniqid())}}" alt="" style="width:240px;" >
    </div>
                    ...
                    <tbody>
                            ...
                            <td colspan="3">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="15%" class="row-p"><label>{{($rectdata->VehicleType == "GOODS VEHICLE" || $rectdata->VehicleType == "CONSTRUCTION EQUIPMENT VEHICLE")?'Unladen Weight':'Sleeper Cap.'}}</label></td>
                                            <td width="35%" class="row-p">: {{($rectdata->txt_sleeper_cap)?$rectdata->txt_sleeper_cap:0}}{{($rectdata->VehicleType == "GOODS VEHICLE" || $rectdata->VehicleType == "CONSTRUCTION EQUIPMENT VEHICLE")?' kg':''}}</td>
											@if ($rectdata->VehicleType != "CONSTRUCTION EQUIPMENT VEHICLE" AND $rectdata->VehicleType !="TEMPORARY REGISTERED VEHICLES")
                                                ...
                                                <ul id="j_idt105_list" class="ui-datalist-data">
													...
													@if($rectdata->civik_amount)
													 <li class="ui-datalist-item">
                                                        <table width="99%" border="1" cellspacing="0" style="border-top: none;border-bottom: 1px #000 solid;border-left: none; border-right: none;" cellpadding="0">
                                                            <tbody><tr>
                                                                <td width="64%">Counter Signature Fee</td>
													...
													@if($rectdata->service_amount)							
                                                     <li class="ui-datalist-item">
                                                        <table width="99%" border="1" cellspacing="0" style="border-top: none;border-bottom: 1px #000 solid;border-left: none; border-right: none;" cellpadding="0">
                                                            <tbody><tr>
                                                                <td width="64%">Surcharge fee</td>
                                                                <td width="12%" style="align: right;"><span class="ui-grid-col-1 right-position">{{$rectdata->service_amount}}</span></td>
                                                                <td width="12%" style="align: right;">0</td>
                                                                <td width="12%" style="align: right;"><span class="ui-grid-col-1 right-position">{{$rectdata->service_amount}}</span></td>
                                                            </tr>
                                                        </tbody></table>
                        ...
                        <tr valign="top">
                            <td colspan="3"><span style="font-weight: bold;">Grand Total : </span><img id="j_idt109"
                                    src="{{asset('raj/Online Tax Payment Portal_files/rupees_sign.png?v='.uniqid())}}" alt="" width="10px"
                                    height="10px"> <span
                                    style="font-weight: bold;">{{$rectdata->total_tax_amount+$rectdata->service_amount+$rectdata->civik_amount}}</span>/- ( <span
