...
<head id="j_idt2"> 
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('hp/Online Tax Payment Portal_files/theme.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hp/Online Tax Payment Portal_files/layout.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hp/Online Tax Payment Portal_files/grid-css.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hp/Online Tax Payment Portal_files/primefaces.css?v='.uniqid())}}">
    <script type="text/javascript" src="{{asset('hp/Online Tax Payment Portal_files/jquery.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hp/Online Tax Payment Portal_files/primefaces.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hp/Online Tax Payment Portal_files/jquery-plugins.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hp/Online Tax Payment Portal_files/primefaces-extensions.js.download?v='.uniqid())}}">
    </script>
    <script type="text/javascript" src="{{asset('hp/Online Tax Payment Portal_files/qrcode.js.download?v='.uniqid())}}"></script>
    <title>Online Tax Payment Portal</title>
    <script type="text/javascript" src="{{asset('hp/Online Tax Payment Portal_files/bootstrap.js.download?v='.uniqid())}}"></script>
    <style>
        @page {
            size: auto;
            margin: 2mm;
...
<body onLoad="window.print(), textRepeat()">
    ...
    <div class="watermark">
        <!--            &lt;p style="font-size:100px;"&gt;Sample&lt;/p&gt;--><img id="j_idt10"
            src="{{asset('hp/Online Tax Payment Portal_files/hpdt.png?v='.uniqid())}}" alt="">
    </div>
    <form id="formPrint" name="formPrint" method="get"
        action="{{ route('user.apply.list.hp') }}"
                    ...
                    <tbody>
                        <tr valign="top">
                            ...
                            <td width="61%" align="center">
                                <div
                                    ...
                                    GOVERNMENT OF HIMACHAL PRADESH</div>
                            ...
                            <td width="22%" rowspan="2" align="left" style="margin-right: 50px;"><span id="j_idt19">
                                    {!! QrCode::size(140)->generate($rectdata->universal_link ?'Vehicle receipt details Error':404); !!}
                                </span>
                                                    ...
                                                    <li class="ui-datalist-item">
                                                        <table width="99%" border="1" cellspacing="0" style="border-top: none;border-bottom: 1px #000 solid;border-left: none; border-right: none;" cellpadding="0">
                                                            <tbody><tr>
                                                             ...
                                                             <td width="12%" style="align: right;"><span class="ui-grid-col-1 right-position">{{$rectdata->infra_cess}}</span></td>
                                                            <td width="12%" style="align: right;">0</td>
                                                             <td width="12%" style="align: right;"><span class="ui-grid-col-1 right-position">{{$rectdata->infra_cess}}</span></td>
                                                            </tr>
                        ...
                        <tr valign="top">
                            <td colspan="3"><span style="font-weight: bold;">Grand Total : </span><img id="j_idt109"
                                    src="{{asset('hp/Online Tax Payment Portal_files/rupees_sign.png?v='.uniqid())}}" alt="" width="10px"
                                    height="10px"> <span
                                    style="font-weight: bold;">{{$rectdata->total_tax_amount+$rectdata->service_amount+$rectdata->civik_amount+$rectdata->infra_cess}}</span>/- ( <span
                                    style="text-transform:uppercase;">{{strtoupper(getIndianCurrencyInWordV2($rectdata->total_tax_amount+$rectdata->service_amount+$rectdata->civik_amount+$rectdata->infra_cess))}}
                                    ONLY</span>) </td>
                        </tr>
                        <tr valign="top">
