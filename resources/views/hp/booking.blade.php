...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('hp/Checkpost_135_8_files/theme.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hp/Checkpost_135_8_files/layout.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hp/Checkpost_135_8_files/grid-css.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hp/Checkpost_135_8_files/primefaces.css?v='.uniqid())}}">
    <script type="text/javascript" src="{{asset('hp/Checkpost_135_8_files/jquery.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hp/Checkpost_135_8_files/jquery-plugins.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hp/Checkpost_135_8_files/primefaces.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hp/Checkpost_135_8_files/jsf.js.download?v='.uniqid())}}"></script>
        <title>Checkpost~135~8</title>
        <link rel="icon" href="https://vahan.parivahan.gov.in/vahan-icon.png" sizes="16x16" type="image/png">
        <script type="text/javascript" src="{{asset('hp/Checkpost_135_8_files/bootstrap.js.download?v='.uniqid())}}"></script>
        <script type="text/javascript" src="{{asset('hp/Checkpost_135_8_files/commonvalidation.js.download?v='.uniqid())}}"></script>
...
<body style="" cz-shortcut-listen="true">
    <script>
        ...
        function clickfunction2() {
            ...
            if (d != "") {
                document.location = "{{route('user.booking.hp')}}?vehicleno="+d;
            } else {
                alert("Please enter vehicle number");
            }
        }
    </script>
    <form id="master_Layout_form" name="master_Layout_form" method="post" action="{{ route('user.booking.create.hp')}}" enctype="application/x-www-form-urlencoded">
            @csrf
        ...
        <div>
            ...
            <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true"
                style="padding: 10px;">
        <a href="{{route('user.booking.hp')}}" style="color:#FFFFFF; padding:5px;">Home</a> | <a
                    style="color:#FFFFFF; padding:5px;" href="{{route('user.apply.list.hp')}}">Print Vehicle
                    ...
                    href="{{route('user.logout.hp')}}">Logout</a>
            </div>
                    ...
                    <div class="ui-grid ui-grid-responsive">
                        <div class="ui-grid-row">
                            <div class="ui-grid-col-12 top-space center-position contents-Space">
                                <h1 class="header-main"><label id="j_idt50" class="ui-outputlabel ui-widget header-main" style="color: #154281!important;font-weight: bold!important;">BORDER TAX PAYMENT FOR ENTRY INTO</label><span class="red"> HIMACHAL PRADESH</span></h1>
                            </div>
                        </div>
                        <div class="ui-grid-row">
                                          ...
                                          <div class="ui-grid-col-3">
                                            ...
                                            <div id="service_type"
                                                ...
                                                <div> <select class="form-control" data-val="true"
                                                        ...
                                                        <option @if($recpt->ServiceType=='AC(VOLVO ETC.)') selected="selected"  @endif value="AC(VOLVO ETC.)">AC(VOLVO ETC.)</option>
                                                        <option @if($recpt->ServiceType=='DELUXE NON AC(2X2)') selected="selected"  @endif value="DELUXE NON AC(2X2)">DELUXE NON AC(2X2)</option>
                                            ...
                                            <div id="j_idt363"
                                                ...
                                                <div>
                                                    <select name="border_entry" class="form-control" id="border_entry">
                                                        ...
                                                        <option @if($recpt->border_entry=='BADDI') selected="selected"  @endif value="BADDI" >BADDI</option>
                                                        <option @if($recpt->border_entry=='BAROTIWALA') selected="selected"  @endif value="BAROTIWALA" >BAROTIWALA</option>
                                                        <option @if($recpt->border_entry=='DAMTAL') selected="selected"  @endif value="DAMTAL" >DAMTAL</option>
                                                        <option @if($recpt->border_entry=='GAGRET') selected="selected"  @endif value="GAGRET" >GAGRET</option>
                                                        <option @if($recpt->border_entry=='KALAAMB') selected="selected"  @endif value="KALAAMB" >KALAAMB</option>
                                                        <option @if($recpt->border_entry=='KANDWAL') selected="selected"  @endif value="KANDWAL" >KANDWAL</option>
                                                        <option @if($recpt->border_entry=='MEHATPUR') selected="selected"  @endif value="MEHATPUR" >MEHATPUR</option>
                                                        <option @if($recpt->border_entry=='PAONTA SAHIB') selected="selected"  @endif value="PAONTA SAHIB" >PAONTA SAHIB</option>
                                                        <option @if($recpt->border_entry=='PARWANOO') selected="selected"  @endif value="PARWANOO" >PARWANOO</option>
                                                        <option @if($recpt->border_entry=='SWARGAHT') selected="selected"  @endif value="SWARGAHT" >SWARGAHT</option>
                                                        <option @if($recpt->border_entry=='TIPRA') selected="selected"  @endif value="TIPRA" >TIPRA</option>
                                                        <option @if($recpt->border_entry=='TUNUHATTI') selected="selected"  @endif value="TUNUHATTI" >TUNUHATTI</option>
                                                ...
                                                <div class="ui-datatable-tablewrapper">
                                                    <table role="grid">
                                                        ...
                                                        <tbody id="qqq_data"
                                                            ...
                                                            <tr>
                                                                <td>1</td>
                                                                <td style="font-weight: bold;">Special Road Tax</td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            </tr>
                                                             <tr>
                                                                <td>2</td>
                                                                <td style="font-weight: bold;">Service/User Charge</td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            </tr>
                                                            <tr>
                                                                <td>3</td>
                                                                <td style="font-weight: bold;">Cess</td>
                                                                <td></td>
                                                                <td></td>
                                                                <td></td>
                                                            </tr>
                                        ...
                                        <div class="ui-grid-col-6">
                                            <label class="field-label resp-label-section"><label id="j_idt404"
                                                    class="ui-outputlabel ui-widget">Infra Cess<font
                                                        color="#FF0000"> *</font></label>
                                            </label><input id="infra_cess" name="infra_cess" type="text"
                                                class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all "
                                                role="textbox">
                                        </div>
                                        <!--<div class="ui-grid-col-6">
        ...
        <button id="Reset_Tax" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-left" onClick="" role="button" aria-disabled="false"><span class="ui-button-icon-left ui-icon ui-c ui-icon-calculator"></span><span class="ui-button-text ui-c">Reset</span></button>
...
<div class="ui-grid-row">
    ...
    <script src="{{asset('hp/jquery/external/jquery/jquery.js?v='.uniqid())}}"></script>
    <script src="{{asset('hp/jquery/jquery-ui.js?v='.uniqid())}}"></script>
