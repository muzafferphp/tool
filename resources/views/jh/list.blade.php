                ...
                <html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><link type="text/css" rel="stylesheet" href="{{asset('jh/Checkpost_135_8_files/theme.css')}}"><link type="text/css" rel="stylesheet" href="{{asset('jh/Checkpost_135_8_files/layout.css')}}"><link type="text/css" rel="stylesheet" href="{{asset('jh/Checkpost_135_8_files/grid-css.css')}}"><link type="text/css" rel="stylesheet" href="{{asset('jh/Checkpost_135_8_files/primefaces.css')}}"><script type="text/javascript" src="{{asset('jh/Checkpost_135_8_files/jquery.js.download')}}"></script><script type="text/javascript" src="{{asset('jh/Checkpost_135_8_files/jquery-plugins.js.download')}}"></script><script type="text/javascript" src="{{asset('jh/Checkpost_135_8_files/primefaces.js.download')}}"></script><script type="text/javascript" src="{{asset('jh/Checkpost_135_8_files/jsf.js.download')}}"></script>
    <title>Checkpost~135~8</title>
    <link rel="icon" href="https://vahan.parivahan.gov.in/vahan-icon.png" sizes="16x16" type="image/png"><script type="text/javascript" src="{{asset('jh/Checkpost_135_8_files/bootstrap.js.download')}}"></script><script type="text/javascript" src="{{asset('jh/Checkpost_135_8_files/commonvalidation.js.download')}}"></script>
    ...
    <body style="">
                            ...
                            <div class="ui-grid ui-grid-responsive">
                                <div class="ui-grid-row">
                                    <div class="ui-grid-col-2 left_logo">
                                        <a style="display: inline-block;" class="top-space"><img id="j_idt11" src="{{asset('jh/Checkpost_135_8_files/logo_e-vahan.png')}}" alt="Parivahan Sewa" style="width: auto;">
                                        </a>
                                    </div>
        ...
        <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true" style="padding: 10px;">
                               <a href="{{route('user.booking.jh')}}" style="color:#FFFFFF; padding:5px;">Home</a> | <a style="color:#FFFFFF; padding:5px;" href="{{route('user.apply.list.jh')}}">Print Vehicle receipt</a> | <a style="color:#FFFFFF; padding:5px;" href="{{route('select-state')}}">Change State</a> | <a style="color:#FFFFFF; padding:5px;" href="{{route('all-booking')}}">All Booking</a>  | <a style="color:#FFFFFF; padding:5px;" href="{{route('user.logout.jh')}}">Logout</a>
                            </div>
                        ...
                        <table style="margin:20px 10px;">
                            ...
                            <tr>
                                <td style="padding: 10px;">
                                    <a target="_blank"
                                        href="{{ route('user.Recpt.print.jh',['rec'=>$rec->receipt_no]) }}">{{$rec->receipt_no_gen}}</a>
                                        {{-- <a target="_blank"
