...
<html xmlns="http://www.w3.org/1999/xhtml"><head id="j_idt2"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script>
        function textRepeat() {
                ...
                document.getElementById("regn_date").innerHTML = str.repeat(34+2);
            }
    </script>
</head>
@php
...
<body onLoad="window.print(), textRepeat()">
    <!-- ,textRepeat()     -->
    <div class="watermark" style="opacity: 1 !important; ">
        <!--            &lt;p style="font-size:100px;"&gt;Sample&lt;/p&gt; left: 780px; top: 90px; !important-->
        <img id="j_idt10"
            src="{{asset('hr/Online Tax Payment Portal_files/BH-logo-2.png?v='.uniqid())}}" style="opacity: 0.7;" alt="" height="276px">

            {{-- https://bihar.vahanparivahanetexservices.com/assets/images/bh_bg.png --}}
    </div>
    <form id="formPrint" name="formPrint" method="get"
        action="{{ route('user.apply.list.br') }}"
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tbody><tr valign="top">
                        ...
                        <td width="61%" align="center">
                            <div
                                ...
                                GOVERNMENT OF BIHAR</div>
                            <div style="font-weight: bold;font-size: 18px;"><b>Department of Transport</b></div>                            <div style="font-weight: bold;font-size: 16px;"><b>Checkpost Tax e-Receipt</b></div>
                        </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                                ...
                                <tr>
                                  ...
                                  <td width="15%" class="row-p"><label>Checkpost Name</label></td>
                                    <td width="35%" class="row-p">: <span class="row-p1">{{strtoupper($rectdata->districtname)}}</span> </td>
                                </tr>
                                <tr>
                                    <td width="15%" class="row-p"><label>Sleeper Cap.</label></td>
                                    <td width="35%" class="row-p">: 0 </td>
                                    @if ($rectdata->VehicleType == "Goods Vehicles")
                                ...
                                <tr>
                                    ...
                                    <td width="35%" class="row-p">:@if($rectdata->payment_mode=='ONLINE') {{$rectdata->bank_ref_no_gen}} @else NA  @endif  </td>
                                  <td width="15%" class="row-p"><label>Payment Mode</label></td>
                                    <td width="35%" class="row-p">: {{strtoupper($rectdata->payment_mode)}}</td>
                                </tr>
                                <tr>
                                    <td width="15%" class="row-p"><label>Service Type</label></td>
                                    <td width="35%" class="row-p">: <span class="row-p1">NOT APPLICABLE</span></td>
                                ...
                                <tr>
                                    ...
                                    <td width="35%" class="row-p">: <span class="row-p1">{{strtoupper($rectdata->PermitType)}}</span> </td>
                                    <td width="15%" class="row-p"><label>Permit Category</label></td>
                                            <td width="35%" class="row-p"></td>
                                </tr>
                                <tr>
                                    <td width="15%" class="row-p"></td>
                    ...
                    <tr valign="top">
                        <td colspan="3"><span style="font-style: italic;">Note : 1) This is a computer generated printout and no signature is required.</span><br><span style="font-style: italic;">2) Incorrect  mentioning of vehicle class or seating capacity may lead to tax evasion and defaulter shall be liable for penal action.</span><br><span style="font-style: italic;"><br>You will also receive the payment confirmation message.</span>
                         <br>  
                         <p style="width:150px;text-align:center;float:right;font-size:100%;font-weight:700;">
                             @if(strtoupper($rectdata->payment_mode)=='CASH')
                             Generated By<br>({{strtoupper($rectdata->genby)}})
                             @endif
                             </p>
                        </td>
                    </tr>
