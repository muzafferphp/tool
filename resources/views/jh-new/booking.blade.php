...
<form id="master_Layout_form" name="master_Layout_form" method="post" action="{{ route('user.booking.create.jh')}}" autocomplete="off" enctype="application/x-www-form-urlencoded" onSubmit="return validateform();">
    @csrf
    <input type="hidden" name="master_Layout_form" value="master_Layout_form">
            ...
            <div>
               ...
               <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true" style="padding: 10px;">
                       <a href="{{route('user.booking.jh')}}" style="color:#FFFFFF; padding:5px;">Home</a> | <a style="color:#FFFFFF; padding:5px;" href="{{route('user.apply.list.jh')}}">Print Vehicle receipt</a> | <a style="color:#FFFFFF; padding:5px;" href="{{route('user.logout')}}">Logout</a>
                    </div>
