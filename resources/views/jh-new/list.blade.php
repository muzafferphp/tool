    ...
    <div>
        ...
        <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true"
            ...
            <a href="{{route('user.booking.jh')}}" style="color:#FFFFFF; padding:5px;">Home</a> | <a
                style="color:#FFFFFF; padding:5px;" href="{{route('user.apply.list.jh')}}">Print Vehicle receipt</a> | <a
    style="color:#FFFFFF; padding:5px;" href="{{route('user.logout.jh')}}">Logout</a>
        </div>
                    ...
                    <table style="margin:20px 10px;">
                        ...
                        <tr>
                            <td style="padding: 10px;">
                                <a target="_blank"
                                    href="{{$rec->user_print_url}}">{{$rec->receipt_no_gen}}</a>
                                    {{-- <a target="_blank"
