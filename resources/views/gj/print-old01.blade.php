...
<head id="j_idt2">
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('gj/Online Tax Payment Portal_files/theme.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('gj/Online Tax Payment Portal_files/layout.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('gj/Online Tax Payment Portal_files/grid-css.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('gj/Online Tax Payment Portal_files/primefaces.css?v='.uniqid())}}">
    <script type="text/javascript" src="{{asset('gj/Online Tax Payment Portal_files/jquery.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('gj/Online Tax Payment Portal_files/primefaces.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('gj/Online Tax Payment Portal_files/jquery-plugins.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('gj/Online Tax Payment Portal_files/primefaces-extensions.js.download?v='.uniqid())}}">
    </script>
    <script type="text/javascript" src="{{asset('gj/Online Tax Payment Portal_files/qrcode.js.download?v='.uniqid())}}"></script>
    <title>Online Tax Payment Portal</title>
    <script type="text/javascript" src="{{asset('gj/Online Tax Payment Portal_files/bootstrap.js.download?v='.uniqid())}}"></script>
    <style>
        @page {
            size: auto;
            margin: 2mm;
...
<body onLoad="window.print(), textRepeat()">
    <!-- ,textRepeat()     -->
    <div class="watermark"  style="top: 47px;">
        <!--            &lt;p style="font-size:100px;"&gt;Sample&lt;/p&gt;--><img id="j_idt10"
            src="{{asset('gj/Online Tax Payment Portal_files/GJ-LOGO.png?v='.uniqid())}}" alt="" height="320" width="320">
    </div>
                    ...
                    <tbody>
                        <tr valign="top">
                            ...
                            <td width="61%" align="center">
                                <div
                                    ...
                                    GOVERNMENT OF GUJARAT</div>
                                <div style="font-weight: 600;">Department of Transport</div>
                                <div style="font-weight: 600;">Checkpost Tax e-Receipt</div>
                            </td>
                            <td width="22%" rowspan="2" align="left" style="margin-right: 50px;"><span id="j_idt19">
                                    {!! QrCode::size(130)->generate($rectdata->universal_link); !!}
                                </span>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="35%" class="row-p">: {{strtoupper($rectdata->TaxMode)}} </td>
                                        </tr>
                                        <tr>
                                            <td width="15%" class="row-p"><label>Vehilce Type</label></td>
                                            <td width="35%" class="row-p">: {{strtoupper($rectdata->VehicleType)}} </td>
                                            <td width="15%" class="row-p"><label>Vehicle Class</label></td>
                                            <td width="35%" class="row-p">: {{strtoupper($rectdata->VehicleClass)}}</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="35%" class="row-p">: {{strtoupper($rectdata->border_entry)}}</td>
                                        </tr>
                                        <tr>
                                                ...
                                                <ul id="j_idt105_list" class="ui-datalist-data">
                                                    <li class="ui-datalist-item">
                                                        <table width="99%" border="1" cellspacing="0"
                                                            style="border-top: none;border-bottom: 0px #000 solid;border-left: none; border-right: none;"
                                                            cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    <td width="64%">Single Return Trip Permit Fee
                                                                    </td>
                                                                    <td width="12%" style="align: right;"><span
                        ...
                        <tr valign="top">
                            <td colspan="3"><span style="font-weight: bold;">Grand Total : </span><img id="j_idt109"
                                    src="{{asset('gj/Online Tax Payment Portal_files/rupees_sign.png?v='.uniqid())}}" alt="" width="10px"
                                    height="10px"> <span
                                    style="font-weight: bold;">{{$rectdata->total_tax_amount + $rectdata->return_amont   }}</span>/- ( <span
                                    style="text-transform:uppercase;">{{strtoupper(getIndianCurrencyInWordV2($rectdata->total_tax_amount + $rectdata->return_amont))}}
                                    ONLY</span>) </td>
                        </tr>
                        <tr valign="top">
...
<html xmlns="http://www.w3.org/1999/xhtml"><head id="j_idt2"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <link type="text/css" rel="stylesheet" href="{{asset('hr/Online Tax Payment Portal_files/theme.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hr/Online Tax Payment Portal_files/layout.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hr/Online Tax Payment Portal_files/grid-css.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('hr/Online Tax Payment Portal_files/components.css?v='.uniqid())}}">
    <script type="text/javascript" src="{{asset('hr/Online Tax Payment Portal_files/jquery.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hr/Online Tax Payment Portal_files/jquery-plugins.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hr/Online Tax Payment Portal_files/core.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hr/Online Tax Payment Portal_files/components.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('hr/Online Tax Payment Portal_files/primefaces-extensions.js.download?v='.uniqid())}}"></script><script type="text/javascript" src="./Online Tax Payment Portal_files/qrcode.js.download"></script><script type="text/javascript">if(window.PrimeFaces){PrimeFaces.settings.locale='en_US';PrimeFaces.settings.projectStage='Development';}</script>
        <title>Online Tax Payment Portal</title>
        <script type="text/javascript" src="{{asset('hr/Online Tax Payment Portal_files/bootstrap.js.download?v='.uniqid())}}"></script>
    <style>
        @page {
            size: auto;
            margin: 2mm;
...
<body onLoad="window.print(), textRepeat()">
    ...
    <div class="watermark">
        <!--            &lt;p style="font-size:100px;"&gt;Sample&lt;/p&gt;--><img id="j_idt10"
            src="{{asset('hr/Online Tax Payment Portal_files/HR-LOGO.png?v='.uniqid())}}" alt="">
    </div>
    <form id="formPrint" name="formPrint" method="post"
        action="https://vahan.parivahan.gov.in/checkpost/faces/public/reports/CustomerReceipt.xhtml"
        enctype="application/x-www-form-urlencoded">
                        ...
                        <td colspan="3">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="">
                                <tbody><tr>
                                  ...
                                  <td width="15%" class="row-p"><label>Tax Mode</label></td>
                                    <td width="35%" class="row-p">: <span class="row-p1">{{$rectdata->TaxMode}}</span></td>
                                </tr>
                                <tr>
                                    <td width="15%" class="row-p"><label>Vehilce Type</label></td>
                                    <td width="35%" class="row-p">: <span class="row-p1">{{$rectdata->VehicleType}}</span> </td>
                                  <td width="15%" class="row-p"><label>Vehicle Class</label></td>
                                    <td width="35%" class="row-p">: <span class="row-p1">{{$rectdata->VehicleClass}}</span></td>
                                </tr>
                                <tr>
                                    <td width="15%" class="row-p"><label>Mobile No.</label></td>
                                    <td width="35%" class="row-p">: <span class="row-p1">{{$rectdata->mobile}}</span></td>
                                  <td width="15%" class="row-p"><label>Checkpost Name</label></td>
                                    <td width="35%" class="row-p">: <span class="row-p1">{{$rectdata->border_entry}}</span> </td>
                                </tr>
                                <tr>
                                    <td width="15%" class="row-p"><label>Sleeper Cap.</label></td>
