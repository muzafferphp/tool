                                                               ...
                                                               <tr role="row" style=" background-color: #fff;">
                                                                ...
                                                                <!--  <tr role="row" style="background-color: #fff;">
                                                                    ...
                                                                    <td class="ui-state-default" role="columnheader">
                                                                        ...
                                                                        {{$gransTotal = $rectdata->total_tax_amount + (isset($rectdata->user_service_charge) ? $rectdata->user_service_charge : 0) + (isset($rectdata->sgst) ? $rectdata->sgst : 0) + (isset($rectdata->cgst) ? $rectdata->cgst : 0)}}
