...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('ka/Checkpost_135_8_files/theme.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('ka/Checkpost_135_8_files/layout.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('ka/Checkpost_135_8_files/grid-css.css?v='.uniqid())}}">
    <link type="text/css" rel="stylesheet" href="{{asset('ka/Checkpost_135_8_files/primefaces.css?v='.uniqid())}}">
    <script type="text/javascript" src="{{asset('ka/Checkpost_135_8_files/jquery.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('ka/Checkpost_135_8_files/jquery-plugins.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('ka/Checkpost_135_8_files/primefaces.js.download?v='.uniqid())}}"></script>
    <script type="text/javascript" src="{{asset('ka/Checkpost_135_8_files/jsf.js.download?v='.uniqid())}}"></script>
        <title>Checkpost~135~8</title>
        <link rel="icon" href="https://vahan.parivahan.gov.in/vahan-icon.png" sizes="16x16" type="image/png">
        <script type="text/javascript" src="{{asset('ka/Checkpost_135_8_files/bootstrap.js.download?v='.uniqid())}}"></script>
        <script type="text/javascript" src="{{asset('ka/Checkpost_135_8_files/commonvalidation.js.download?v='.uniqid())}}"></script>
...
<body style="" cz-shortcut-listen="true">
    <script>
        ...
        function clickfunction2() {
            ...
            if (d != "") {
                document.location = "{{route('user.booking.ka')}}?vehicleno="+d;
            } else {
                alert("Please enter vehicle number");
            }
        }
    </script>
    <form id="master_Layout_form" name="master_Layout_form" method="post" action="{{ route('user.booking.create.ka')}}" enctype="application/x-www-form-urlencoded">
            @csrf
        ...
        <div>
            ...
            <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true"
                style="padding: 10px;">
        <a href="{{route('user.booking.ka')}}" style="color:#FFFFFF; padding:5px;">Home</a> | <a
                    style="color:#FFFFFF; padding:5px;" href="{{route('user.apply.list.ka')}}">Print Vehicle
                    ...
                    href="{{route('user.logout.ka')}}">Logout</a>
            </div>
                    ...
                    <div class="ui-grid ui-grid-responsive">
                        <div class="ui-grid-row">
                            <div class="ui-grid-col-12 top-space center-position contents-Space">
                                <h1 class="header-main"><label id="j_idt50" class="ui-outputlabel ui-widget header-main" style="color: #154281!important;font-weight: bold!important;">BORDER TAX PAYMENT FOR ENTRY INTO</label><span class="red"> Karnataka</span></h1>
                            </div>
                        </div>
						<div class="ui-grid-row">
                    <div class="ui-grid-col-12 center-position contents-Space"><div id="j_idt1494" class="ui-outputpanel ui-widget dark-blue-span font-bold small-font">Note: The composite rates have been revised w.e.f. Jan 2019. Please pay as per new rates who have paid monthly fee earlier in advance.</div>
                    </div>
                </div>
                                ...
                                <div id="uktaxcollection"
                                        ...
                                        <div class="ui-grid-col-3">
                                            ...
                                            <div id="j_idt327"
                                                ...
                                                <div><select class="form-control" data-val="true"
														...
														<option @if($recpt->VehicleClass=='PRIVATE SERVICE VEHICLE') selected="selected"  @endif value="PRIVATE SERVICE VEHICLE">PRIVATE SERVICE VEHICLE</option>
														<option @if($recpt->VehicleClass=='EDUCATIONAL BUS') selected="selected"  @endif value="EDUCATIONAL BUS">EDUCATIONAL BUS</option>
														<option @if($recpt->VehicleClass=='CAMPER VAN / TRAILER') selected="selected"  @endif value="CAMPER VAN / TRAILER">CAMPER VAN / TRAILER</option>
														...
														<option @if($recpt->VehicleClass=='MOBILE CANTEEN') selected="selected"  @endif value="MOBILE CANTEEN">MOBILE CANTEEN</option>
                                                        <option @if($recpt->VehicleClass=='LIBRARY VAN') selected="selected"  @endif value="LIBRARY VAN">LIBRARY VAN</option>
                                                        <option @if($recpt->VehicleClass=='MOBILE WORKSHOP') selected="selected"  @endif value="MOBILE WORKSHOP">MOBILE WORKSHOP</option>
                                                        <option @if($recpt->VehicleClass=='MOBILE CLINIC') selected="selected"  @endif value="MOBILE CLINIC">MOBILE CLINIC</option>
                                                        <option @if($recpt->VehicleClass=='CASH VAN') selected="selected"  @endif value="CASH VAN">CASH VAN</option>
														<option @if($recpt->VehicleClass=='ARTICULATED VEHICLE') selected="selected"  @endif value="ARTICULATED VEHICLE">ARTICULATED VEHICLE</option>
														<option @if($recpt->VehicleClass=='MULTI-AXLED GOODS') selected="selected"  @endif value="MULTI-AXLED GOODS">MULTI-AXLED GOODS</option>
														...
														<option @if($recpt->VehicleClass=='VEHICLE FITTED WITH RIG') selected="selected"  @endif value="VEHICLE FITTED WITH RIG">VEHICLE FITTED WITH RIG</option>
														<option @if($recpt->VehicleClass=='VEHICLE FITTED WITH COMPRESSOR') selected="selected"  @endif value="VEHICLE FITTED WITH COMPRESSOR">VEHICLE FITTED WITH COMPRESSOR</option>
														<option @if($recpt->VehicleClass=='CRANE MOUNTED VEHICLE') selected="selected"  @endif value="CRANE MOUNTED VEHICLE">CRANE MOUNTED VEHICLE</option>
														<option @if($recpt->VehicleClass=='TOWER WAGONS') selected="selected"  @endif value="TOWER WAGONS">TOWER WAGONS</option>
                                                        <option @if($recpt->VehicleClass=='TREE TRIMMING VEHICLE') selected="selected"  @endif value="TREE TRIMMING VEHICLE">TREE TRIMMING VEHICLE</option>
														<option @if($recpt->VehicleClass=='FORK LIFT') selected="selected"  @endif value="FORK LIFT">FORK LIFT</option>
                                                        <option @if($recpt->VehicleClass=='VEHICLE FITTED WITH AIR GENERATOR') selected="selected"  @endif value="VEHICLE FITTED WITH AIR GENERATOR">VEHICLE FITTED WITH AIR GENERATOR</option>
										  ...
										  <div class="ui-grid-col-3">
                                            ...
                                            <div id="service_type"
                                                ...
                                                <div> <select class="form-control" data-val="true"
													...
													<option @if($recpt->ServiceType=='LUXURY') selected="selected"  @endif value="LUXURY">LUXURY
                                                        </option>
														<option @if($recpt->ServiceType=='SLEEPER') selected="selected"  @endif value="SLEEPER">SLEEPER
                                                        </option>
                                    ...
                                    <div class="ui-grid-row">
										...
										<div class="ui-grid-col-3">
											...
											<div class="ui-grid-col-3">
                                            <label class="field-label resp-label-section"><label id="floor"
                                                    class="ui-outputlabel ui-widget">Floor Area(in meter)</label>
                                            </label><input id="txt_floor_area" name="txt_floor_area" type="text"
                                                value="" maxlength="2"
                                                onkeypress="return NumericOnly(event, &#39;&#39;);"
                                                class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all "
                                                role="textbox">
                                   ...
                                   <div class="ui-grid-row">
                                        ...
                                        -->
										   <div class="ui-grid-col-3">
                                            <label class="field-label resp-label-section"><label id="j_idt373"
                                                    ...
                                                    placeholder="DD-MM-YYYY" value="{{$recpt->permit_upto}}" autocomplete="off"></span>
                                        </div>
										...
										<div class="ui-grid-col-3">
                                            <label class="field-label resp-label-section"><label id="j_idt353"
                                                    ...
                                                    class="ui-inputfield ui-widget ui-state-default ui-corner-all  "
                                            placeholder="DD-MM-YYYY" value="{{$recpt->fitdate}}" autocomplete="off" ></span>
                                        </div>
										<div class="ui-grid-col-3">
                                            <label class="field-label resp-label-section"><label id="j_idt353"
                                                    class="ui-outputlabel ui-widget">Insurance Validity(upto)<font
                                                        color="#FF0000"> *</font></label>
                                            </label><span id="j_idt355"><input id="ins_upto" name="ins_upto" type="text"
                                                    class="ui-inputfield ui-widget ui-state-default ui-corner-all  "
                                            placeholder="DD-MM-YYYY" value="{{@$recpt->ins_upto}}"></span>
                                        </div>
										<div class="ui-grid-col-3">
                                            <label class="field-label resp-label-section"><label id="j_idt353"
                                                    class="ui-outputlabel ui-widget">Tax Validity(upto)<font
                                                        color="#FF0000"> *</font></label>
                                            </label><span id="j_idt355"><input id="tax_validity" name="tax_validity" type="text"
                                                    class="ui-inputfield ui-widget ui-state-default ui-corner-all  "
                                            placeholder="DD-MM-YYYY" value="{{@$recpt->tax_validity}}"></span>
                                        </div>
										     <!--<div class="ui-grid-col-3">
                                  ...
                                  <!--<div class="ui-grid-row">
                                            ...
                                            <div id="j_idt363"
                                                ...
                                                <div>
                                                    <select name="border_entry" class="form-control" id="border_entry">
														...
														<option @if($recpt->border_entry=='ALAND') selected="selected"  @endif value="ALAND" >ALAND</option>
														<option @if($recpt->border_entry=='ATTIBELE') selected="selected"  @endif value="ATTIBELE" >ATTIBELE</option>
														<option @if($recpt->border_entry=='BAGEPALLI') selected="selected"  @endif value="BAGEPALLI" >BAGEPALLI</option>
														<option @if($recpt->border_entry=='CHIKKAHOLE') selected="selected"  @endif value="CHIKKAHOLE" >CHIKKAHOLE</option>
														<option @if($recpt->border_entry=='GOWRIBIDANUR') selected="selected"  @endif value="GOWRIBIDANUR" >GOWRIBIDANUR</option>
														<option @if($recpt->border_entry=='GUNDLUPET') selected="selected"  @endif value="GUNDLUPET" >GUNDLUPET</option>
														<option @if($recpt->border_entry=='HAGARI') selected="selected"  @endif value="HAGARI" >HAGARI</option>
														<option @if($recpt->border_entry=='HUMNABAD') selected="selected"  @endif value="HUMNABAD" >HUMNABAD</option>
														<option @if($recpt->border_entry=='KAGAWADA') selected="selected"  @endif value="KAGAWADA" >KAGAWADA</option>
														<option @if($recpt->border_entry=='NANGLI') selected="selected"  @endif value="NANGLI" >NANGLI</option>
														<option @if($recpt->border_entry=='NIPPANI / KOGNALLI') selected="selected"  @endif value="NIPPANI / KOGNALLI" >NIPPANI / KOGNALLI</option>
														<option @if($recpt->border_entry=='RAMANAGAR') selected="selected"  @endif value="RAMANAGAR" >RAMANAGAR</option>
                                                        <option @if($recpt->border_entry=='RAYALPADU') selected="selected"  @endif value="RAYALPADU">RAYALPADU</option>
                                                        <option @if($recpt->border_entry=='THALAPADI') selected="selected"  @endif value="THALAPADI">THALAPADI</option>
                                                        <option @if($recpt->border_entry=='ZALKI') selected="selected"  @endif value="ZALKI">ZALKI</option>
                                       ...
                                       <!--<div class="ui-grid-col-3">
                                        ...
                                        <div class="ui-grid-col-3">
                                            <label class="field-label resp-label-section"><label id="j_idt387"
                                                ...
                                                @php
                                                $timePaid = strtoupper(now()->format('d-M-Y h:m A'));
                                                @endphp
                                                <input id="tax_from" name="tax_from"
                                                    type="text"
                                                    class="ui-inputfield ui-widget ui-state-default ui-corner-all  "
                                            placeholder="DD-MM-YYYY" value="{{$timePaid}}" autocomplete="off"></span>
                                        </div>
                                        <div class="ui-grid-col-3">
                                    ...
                                    <div class="ui-grid-row">
                                        ...
                                        <div class="ui-grid-col-6">
                                            <label class="field-label resp-label-section"><label id="j_idt404"
                                                    class="ui-outputlabel ui-widget">Cess<font
                                                        color="#FF0000"> *</font></label>
										...
										<div class="ui-grid-col-6">
                                            <label class="field-label resp-label-section"><label id="j_idt404"
                                                    class="ui-outputlabel ui-widget">infra cess<font
                                                        color="#FF0000"> *</font></label>
                                            </label><input id="service_amount" name="infra_cess" type="text"
                                                class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                                                role="textbox">
                                        </div>
										<div class="ui-grid-col-5">
                                            <label class="field-label resp-label-section"><label id="j_idt404"
                                                    class="ui-outputlabel ui-widget">Permit Fee<font
                                                        color="#FF0000"> *</font></label>
                                            </label><input id="service_amount" name="permit_fee" type="text"
                                                class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                                                role="textbox">
                                        </div>
										<div class="ui-grid-col-5">
                                            <label class="field-label resp-label-section"><label id="j_idt404"
                                                    class="ui-outputlabel ui-widget">Permit Endoresment<font
                                                        color="#FF0000"> *</font></label>
                                            </label><input id="service_amount" name="permit_endoresment_variation" type="text"
                                                class="ui-inputfield ui-inputtext ui-widget ui-state-default ui-corner-all"
                                                role="textbox">
                                        </div>
                                        <!--<div class="ui-grid-col-6">
...
<div class="ui-grid-row">
                        <div class="ui-grid-col-12">
                            <div id="footer_view">                          
                                <marquee scrollamount="2" behavior="alternate" scrolldelay="1" onmouseover="this.stop();" onmouseout="this.start();" direction="left"><div class="dark-blue-span font-bold small-font">NOTE: - Incorrect  mentioning of vehicle class or seating capacity may lead to tax evasion and defaulter shall be liable for penal action.</div></marquee>                      
                            </div>
                        </div>
                    </div>
    </form>

    <script src="{{asset('ka/jquery/external/jquery/jquery.js?v='.uniqid())}}"></script>
    <script src="{{asset('ka/jquery/jquery-ui.js?v='.uniqid())}}"></script>
...
<script>
  ...
  $( function() {
    $( "#tax_from" ).datepicker({ dateFormat: 'dd-M-yy', onSelect: function(datetext) {
  ...
  $( function() {
    $( "#tax_upto" ).datepicker({ dateFormat: 'dd-M-yy',onSelect: function(datetext) {
            var d = new Date(); // for now
