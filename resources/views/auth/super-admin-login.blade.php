...
<head>
    ...
    <!-- CSRF Token -->
    <meta name="csrf-token" content="HwQACAO9FIc3BC4hVk5publvScTw6VdAOpDFop9N">
...
<body>
    <div class="full-page-bg" data-style="background-image: url(/th/pub/asset/img/login-bg.jpg);">
        <div class="log-overlay"></div>
        <div class="full-page-bg-inner">
            <div class="row no-margin">
                <div class="col-md-8 log-left">
                    {{-- <span class="login-logo">
                        <img src="/th/pub/uploads/5460c0f3c5cc7ecd856eb51de1913543fc18e93b.png">
                    </span> --}}

                    <h2>{{config("app.name")}}</h2>
                    <h2 class="small">SuperAdmin Log In</h2>
                ...
                <div class="col-md-4 log-right">
                    <div class="login-box-outer">
                        <div class="login-box row no-margin">
                            <div class="col-md-12">

                                {{-- <a class="log-blk-btn" href="register.html">CREATE NEW ACCOUNT</a> --}}
                                <h3>SuperAdmin Log In</h3>
                            </div>

                            <div class="col-md-12">
                                <form role="form" method="POST" action="{{ route('super-admin.login') }}">
                                    @csrf
                        ...
                        <div class="log-copy">
                            <p class="no-margin">&copy; {{now()->format('Y')}} {{config("app.name")}}</p>
                        </div>
                    </div>
                </div>
            </div>
