...
<link type="text/css" rel="stylesheet" href="{{asset('mh/css/style.css')}}" />
...
<div style="float:left;"><img src="{{asset('mh/images/logo.png')}}" style="margin:5px;" /></div>
...
<form name="form1" method="post" action="{{route('user.login.submit.mh')}}"  id="form1">
    @csrf
